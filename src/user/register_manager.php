        ...
        <div class="signup-containers">
           ...
           <form id="submitForm" class="input-container-signup">
                <div class="signdis">
                    ...
                    <div class="input-container">
                        <input type="text" id="email" name="email" required placeholder="example@gmail...">
                    </div>
                    <div class="input-container">
                ...
                <div class="payment_">
                    ...
                    <div class="rowss">
                            <div id="id_div">
                                <p>Account Name: <span>Sample Name</span></p>
                                <p>Account Number: <span>09992221212</span></p>
                            </div>
                    </div>
                    <div class="input-container">
            ...
            <div class="sign_up">
                <p>or</p>
                <a href="login">login</a> / <a href="register_traveller">Register as Traveller</a>
            </div>
        </div>
    </div>
