...
var timertable;
    ...
    $('#search').keyup(function(){
        ...
        if ($('#search').val) {
            timertable = setTimeout(function(){
                ...
                if(search==''){
                    window.location.href="manager-data?manager_id="+manager_id+"#tabs";
                }else{
                    window.location.href="manager-data?manager_id="+manager_id+"&search="+search+"#tabs";
                }
            }, timeouttable);
        }
    });
    ...
    $(document).on('click','#showinfo',function(){
        ...
        window.location.href="payment-data?payment_id="+id;
    });
