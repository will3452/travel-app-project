                                    ...
                                    <?php if(isset($_GET['search'])): ?>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Email</span>
                                                <div class="sorted-table">
                                                    <div><a href="?search=<?php echo $_GET['search'] ?>&email=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?search=<?php echo $_GET['search'] ?>&email=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Email</span>
                                                <div class="sorted-table">
                                                    <div><a href="?email=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?email=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">Name</th>
                                ...
                                <tbody class="hideafter">
                                    <?php foreach ($display as $dis): ?>
                                        <tr class="<?php echo $dis['id']; ?>" id="<?php echo $dis['id']; ?>">
                                            ...
                                            <td><a href="view/manager-data?manager_id=<?php  echo $dis['id']; ?>"><?php echo $dis['email']; ?></a></td>
