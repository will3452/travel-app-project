                    <?php
                        $User = new User;
                        include '_UI_SORTING_FETCHING/payment-main-fetch.php';
                    ?>
                    <!-- search -->
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div id="tabs">Payment Record Table</div>
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                            include '_UI_SORTING_FETCHING/limit-sort-payment-main.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                        <div class="card-body-table overflowtables">
                            ...
                            <div class='bottomtable overflowtables'>
                                <div class="pre-nex">
                                    <?php 
                                        include '_UI_SORTING_FETCHING/payment-main-pagination-fetch.php';    
                                    ?>
                                </div>
                            </div>
                        </div>
