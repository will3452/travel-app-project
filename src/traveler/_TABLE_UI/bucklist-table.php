                                ...
                                <tbody class="hideafter">
                                    <?php foreach ($display as $dis): ?>
                                        <tr class="<?php echo $dis['id']; ?>" id="<?php echo $dis['id']; ?>">
                                           <?php 
                                                $serviceid = $dis['package_id'];
                                                //get service info
                                                $GetServiceExist = $Service->GetServiceExist($serviceid);
                                           ?>
                                            <td data-target="name"><a href="view/service-data?host_view=<?php echo $GetServiceExist->business_id; ?>&service_id=<?php echo $GetServiceExist->id; ?>"><?php echo $GetServiceExist->name; ?></a></td>
