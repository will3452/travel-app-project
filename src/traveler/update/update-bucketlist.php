                ...
                <div class="container-fluid px-4">
                    ...
                    <form id="submitForm">  
                        ...
                        <?php 
                            ...
                            <input type="hidden" id="service_id" name="service_id" value="<?php echo $GetServiceExist->id; ?>">
                            <input type="hidden" id="host_view" name="host_view" value="<?php echo $GetServiceExist->business_id; ?>">
                            ...
                            <div class="rowss">
                                    ...
                                    <div id="idcontent">
                                            <p><?php echo ucwords( $GetServiceExist->name); ?></p>
                                    </div>
                            </div>
                            <div class="rowss">
                                    <div id="id_div">
                                    ...
                                    <div id="idcontent">
                                            <p>₱<?php echo $GetServiceExist->price; ?></p>
                                    </div>
                            </div>
                            <div class="rowss">
                                <div id="id_div">
