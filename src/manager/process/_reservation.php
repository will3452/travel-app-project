        ...
        if($ValidateToken==1){
            ...
            if($ValidateFields==1){
                ...
                if($GetBookManager){
                    ...
                    $update = $Reservation->UpdateReservation($res_id, $User::STATUS_HISTORY, $User::STATUS_DROP, $businessid);
                    ...
                    if($update){
                        ...
                        $message = 'Your Book in '. $businessname.' at '.$dateofbook. ' '.date("h:i:A", strtotime($timeofbook)).' Has been drop';
