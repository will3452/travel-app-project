...
class Mail extends User{
    ...
    Public function SendMailMessage($protocollinks, $title_mail, $headtitle, $message_content, $emailsender){
        ...
        return "<html lang='en'>
            ...
            padding: 10px 20px;'>
                <p>$emailsender</p>
                <p>$message_content </p>
                <p> Click here to reply <a href='$protocollinks'>$protocollinks</a></p>
