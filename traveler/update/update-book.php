<?php 
    ...
    if($data->status==$User::STATUS_HISTORY || $data->status==$User::STATUS_APPROVED){
...
<head>
    ...
    <title>Traveler - Update Book</title>
</head>
                ...
                <div class="container-fluid px-4">
                    ...
                    <form id="submitForm">  
                        ...
                        <?php 
                            ...
                            ?> 
                            <input type="hidden" id="token_update_book" name="token_update_book" value="<?php echo password_hash(Date('Y-m-d').'token-ps', PASSWORD_BCRYPT); ?>"> 
                        ...
                        <div class="button-add-emp">
                           <a href="../view/booking-data?book_id=<?php echo $_GET['book_id']; ?>" id="cancel">Cancel</a>
                            <button type="submit" id="buttonss" name="button">
                                <span id="spansubmit">Update To Book</span>
