...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    ...
                    <form id="submitForm">
                        ...
                        <?php
                            ...
                            ?>
                            <input type="hidden" id="token_add_reviews" name="token_add_reviews" value="<?php echo password_hash(Date('Y-m-d').'token-ps', PASSWORD_BCRYPT); ?>">
                            ...
                            <div class="rowss">
                                <div id="id_div">
                                        <p>Rate <i class="fa-solid fa-star"></i> <span style="color:red;">*</span></p>
                                </div>
                                <div id="idcontent">
    ...
    <script src="../js/review-host.js?v=3"></script>
