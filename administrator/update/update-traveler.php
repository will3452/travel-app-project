...
<head>
    ...
    <title>Admin - Update Traveler</title>
</head>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <p class="mt-4 edit-title">Update Traveler</p>
                    <br>
                    <form id="submitForm_profile">
                        ...
                        <input type="hidden" id="token_profile" name="token_profile" value="<?php echo password_hash(Date('Y-m-d').'token-ps', PASSWORD_BCRYPT); ?>">
                            ...
                            <input type="hidden" id="traveler_id" name="traveler_id" value="<?php echo $_GET['traveler_id']; ?>">
                            <div class="rowss">
                                <div id="id_div">
