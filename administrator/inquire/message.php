...
<head>
    ...
    <title>Admin - Manager Inquire</title>
</head>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <p class="mt-4 edit-title">Manager Inquire</p>
                    <a href="../manager"><button id="backpage_color"><i class="fas fa-arrow-circle-left"></i></button></a>
                    <form id="form_initialize_chat">
                        <input type="hidden" id="receiver" value="<?php  echo $userdata->email; ?>" placeholder="receiver">
                        ...
                        <div class="chat_main_body">
                            ...
                            <div class="chat_form">
                                <form id="submit_text">
                                    ...
                                    <input type="hidden" id="messageReciever" name="messageReciever" value="<?php  echo $userdata->email; ?>">
