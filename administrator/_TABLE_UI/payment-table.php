<?php
                        ...
                        include '_UI_SORTING_FETCHING/payment-fetch.php';
                    ?>
                    <!-- search -->
                        ...
                        <div class="card-header">
                            ...
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                            include '_UI_SORTING_FETCHING/limit-sort-payment.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                ...
                                                <div class="sorted-table">
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&search=<?php echo $_GET['search'] ?>&id=asc#tabs"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&search=<?php echo $_GET['search'] ?>&id=desc#tabs"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Date</span>
                                                <div class="sorted-table">
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&search=<?php echo $_GET['search'] ?>&date=asc#tabs"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&search=<?php echo $_GET['search'] ?>&date=desc#tabs"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <?php else: ?>
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>ID </span>
                                                <div class="sorted-table">
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&id=asc#tabs"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&id=desc#tabs"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Date</span>
                                                <div class="sorted-table">
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&date=asc#tabs"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?manager_id=<?php echo $manager_id; ?>&date=desc#tabs"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">type of payment</th>
