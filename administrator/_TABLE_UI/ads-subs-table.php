<?php                   
                        ...
                        include '_UI_SORTING_FETCHING/advertisementsubs-fetch.php';
                    ?>
                    <!-- search -->
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                            include '_UI_SORTING_FETCHING/limit-sort-adds-subs.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                        <div class="card-body-table overflowtables">
                                    ...
                                    <?php if(isset($_GET['search'])): ?>
                                        <th scope="col">
                                            <div class="d-flex">
                                                ...
                                                <div class="sorted-table">
                                                    <div><a href="?tab=ads_sub&search=<?php echo $_GET['search'] ?>&id=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=ads_sub&search=<?php echo $_GET['search'] ?>&id=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                ...
                                                <div class="sorted-table">
                                                    <div><a href="?tab=ads_sub&search=<?php echo $_GET['search'] ?>&date=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=ads_sub&search=<?php echo $_GET['search'] ?>&date=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <?php else: ?>
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>ID </span>
                                                <div class="sorted-table">
                                                    <div><a href="?tab=ads_sub&id=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=ads_sub&id=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">Profile</th>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Schedule At </span>
                                                <div class="sorted-table">
                                                    <div><a href="?tab=ads_sub&date=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=ads_sub&date=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">Package</th>
                                ...
                                <tbody class="hideafter">
                                    <?php foreach ($display as $dis): ?>
                                        <tr class="<?php echo $dis['id']; ?>" id="<?php echo $dis['id']; ?>">
                                            ...
                                            <?php 
                                                $idmanger = $dis['manager_id'];
                                                $packageid = $dis['package_id'];
                                            ...
                                            <td><?php echo $dis['schedule_at']; ?></td>
                                            <td><a href="view/package-data?pack_id=<?php echo $packageid; ?>"><?php echo $GetPromoData->name; ?></a></td>
                                            ...
                                            <td id="btn">
                                                <div class="d-flex">
                                                    ...
                                                    <?php if($dis['status']==$User::STATUS_ONGOING): ?>
                                                        <span class="tip_accept_container">
                                                            <i class="fas fa-check-circle btns" id="done" data-id="<?php echo $dis['id']; ?>"></i>
                            ...
                            <div class='bottomtable overflowtables'>
                                <div class="pre-nex">
                                    <?php 
                                        include '_UI_SORTING_FETCHING/subs-ads-pagination-fetch.php';    
                                    ?>
                                </div>
                            </div>
                        </div>
