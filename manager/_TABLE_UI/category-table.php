<?php
                        ...
                        include '_UI_SORTING_FETCHING/category-fetch.php';
                    ?>
                    <!-- search -->
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                            include '_UI_SORTING_FETCHING/limit-sort-category.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='bottomtable overflowtables'>
                                <div class="pre-nex">
                                    <?php 
                                        include '_UI_SORTING_FETCHING/category-pagination-fetch.php';    
                                    ?>
                                </div>
                            </div>
                    </div>