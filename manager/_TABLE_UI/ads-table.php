<?php
                        ...
                        $iduser = $GetUserID->id;
                        include '_UI_SORTING_FETCHING/ads-fetch.php';
                    ?>
                    <!-- search -->
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                            include '_UI_SORTING_FETCHING/ads-sort-category.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody class="hideafter">
                                    <?php foreach ($display as $dis): ?>
                                        <tr class="<?php echo $dis['id']; ?>" id="<?php echo $dis['id']; ?>">
                                            ...
                                            <?php 
                                                $idpackage = $dis['package_id']; 
                                                $GetPromoData = $Promotion->GetPromoData($idpackage);
                                            ?>
                                            <td data-target="name"><a href="view/promotion-ads-data?promo_id=<?php echo $dis['package_id']; ?>"><?php echo $GetPromoData->name; ?></a></td>
                                            <td><?php echo date("Y-m-d", strtotime($dis['schedule_at'])); ?></td>
                                            <td><?php echo date("Y-m-d", strtotime($dis['end_at'])); ?></td>
                        ...
                        <div class='bottomtable overflowtables'>
                                <div class="pre-nex">
                                    <?php 
                                        include '_UI_SORTING_FETCHING/ads-pagination-fetch.php';    
                                    ?>
                                </div>
                            </div>
                    </div>