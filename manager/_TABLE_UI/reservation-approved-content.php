                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                                    include '_UI_SORTING_FETCHING/reservation-sort2.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                        <div class="card-body-table overflowtables">
                                    ...
                                    <?php if(isset($_GET['search'])): ?>
                                        <th scope="col">
                                            <div class="d-flex">
                                                ...
                                                <div class="sorted-table">
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&search=<?php echo $_GET['search'] ?>&id=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&search=<?php echo $_GET['search'] ?>&id=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Date </span>
                                                <div class="sorted-table">
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&search=<?php echo $_GET['search'] ?>&date=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&search=<?php echo $_GET['search'] ?>&date=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <?php else: ?>
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>ID </span>
                                                <div class="sorted-table">
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&id=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&id=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">Profile</th>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex">
                                                <span>Date </span>
                                                <div class="sorted-table">
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&date=asc"><i class="fas fa-chevron-up"></i></a></div>
                                                    <div><a href="?tab=<?php echo $_GET['tab']; ?>&date=desc"><i class="fas fa-chevron-down"></i></a></div>
                                                </div>
                                            </div>
                                        </th>
                                        <th scope="col">Time</th>
                            ...
                            <div class='bottomtable overflowtables'>
                                <div class="pre-nex">
                                    <?php 
                                        include '_UI_SORTING_FETCHING/reservation-pagination-fetch2.php';    
                                    ?>
                                </div>
                            </div>
                        </div>
