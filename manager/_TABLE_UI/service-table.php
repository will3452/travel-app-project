<?php
                        ...
                        include '_UI_SORTING_FETCHING/services-fetch.php';
                    ?>
                    <!-- search -->
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="dropdown-per-page">
                                ...
                                <div class="dropdown-menu" id="dropdown" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php 
                                            include '_UI_SORTING_FETCHING/limit-sort-service.php';
                                        ?> 
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody class="hideafter">
                                    <?php foreach ($display as $dis): ?>
                                        <tr class="<?php echo $dis['id']; ?>" id="<?php echo $dis['id']; ?>">
                                            ...
                                            <td id="imgtd">
                                                <img id="vievimage" data-attr="../images/services/<?php echo $dis['image']; ?>" src="../images/services/<?php echo $dis['image']; ?>" alt="">
                                            </td>
                                            <td data-target="name"><?php echo $dis['name'];?></td>
                                            <td>₱<?php echo $dis['price'];?></td>
                                            <td><?php echo ucwords($dis['category']);?></td>
                                            <td id="btn">
                                                <div class="d-flex">
                        ...
                        <div class='bottomtable overflowtables'>
                                <div class="pre-nex">
                                    <?php 
                                        include '_UI_SORTING_FETCHING/services-pagination-fetch.php';    
                                    ?>
                                </div>
                            </div>
                    </div>