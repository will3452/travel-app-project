...
<head>
    ...
    <title>Manager - Create Reservation</title>
</head>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <p class="mt-4 edit-title">Create Reservation</p>
                    <form id="submitForm">  
                        <div class="form-container-user">
                            ...
                            ?> 
                            <input type="hidden" id="token_create_reservation" name="token_create_reservation" value="<?php echo password_hash(Date('Y-m-d').'token-ps', PASSWORD_BCRYPT); ?>"> 

                            <div class="rowss">
                                <div id="id_div">
                                        <p>Travelere Email <span style="color:red;">*</span></p>
                                </div>
                                <div id="idcontent">
                                        <input type="email" id="email" name="email" required class="focusinput" placeholder="-------">
                                </div>
                            </div>
                            <div class="rowss">
                                <div id="id_div">
                        ...
                        <div class="button-add-emp">
                           <a href="../services" id="cancel">Cancel</a>
                            <button type="submit" id="buttonss" name="button">
                                <span id="spansubmit">Create Reservation</span>
