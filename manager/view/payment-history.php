        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <p class="mt-4 edit-title">View Payment History</p>
                    <a href="../payment-history"><button id="backpage_color"><i class="fas fa-arrow-circle-left"></i></button></a>
                    <br>
                    <div class="form-container-user">
                        <div class="rowss">
                                ...
                                <div id="idcontent" class="imgviews">
                                    <img src="/../images/pop/<?php echo $data->img; ?>" alt="">
                                </div>
                        </div>
                        <div class="rowss">
                                <div id="id_div">
                                ...
                                <div id="idcontent">
                                        <p><?php echo sprintf('%06d',$_GET['py_id']); ?></p>
                                </div>
                        </div>
                        <div class="rowss">
                                <div id="id_div">
